...
class RoastsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create roast" do
    assert_difference('Roast.count') do
      post roasts_url, params: { roast: { description: @roast.description, name: @roast.name, origin: @roast.origin, roaster: @roast.roaster } }
    end
  ...
  test "should update roast" do
    patch roast_url(@roast), params: { roast: { description: @roast.description, name: @roast.name, origin: @roast.origin, roaster: @roast.roaster } }
